<x-shop-layout title="Detail Produk">
    <div class="max-w-6xl mx-auto px-4 py-10">
        ...
        <div class="bg-white rounded-3xl border border-decora-cream-dark overflow-hidden mb-14">
            <div class="grid grid-cols-1 md:grid-cols-2 md:h-[440px]">
                ...
                <div class="p-6 sm:p-8 flex flex-col justify-center overflow-y-auto">
                    ...
                    <span class="inline-block w-fit px-3 py-1 rounded-full text-xs font-semibold bg-decora-sage/30 text-decora-brown-dark mb-4">
                        {{ $produk->kategori }}
                    </span>

                    <h1 class="text-2xl sm:text-3xl font-bold text-decora-text mb-3">{{ $produk->nama }}</h1>

                    <p class="text-3xl font-bold text-decora-brown mb-4">
                    ...
                    <div class="border-t border-decora-cream-dark pt-5 mb-6">
                    ...
                    @auth
                        ...
                        @else
                            <p class="text-red-600 font-semibold mb-8">Stok produk ini sedang habis.</p>
                        @endif
                    @else
                        <div class="bg-decora-cream rounded-lg p-4 mb-8 text-sm text-decora-text/70">
                            <a href="{{ route('login') }}" class="text-decora-brown font-semibold underline">Login</a> terlebih dahulu untuk membeli produk ini.
                        </div>
                    @endauth

                    {{-- Badge kepercayaan --}}
                    <div class="flex flex-wrap gap-x-6 gap-y-2 pt-5 border-t border-decora-cream-dark text-xs text-decora-text/60">
